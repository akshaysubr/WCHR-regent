...
task main()
  ...
  --                       PARTITIONING
  --------------------------------------------------------------------------------------------
  var coords_x    = partition_xpencil_coords(coords, n_ghosts, false, pencil)
  var coords_y    = partition_ypencil_coords(coords, n_ghosts, false, pencil)
  var coords_z    = partition_zpencil_coords(coords, n_ghosts, false, pencil)

  var coords_x_wg = partition_xpencil_coords(coords, n_ghosts,  true, pencil)
  var coords_y_wg = partition_ypencil_coords(coords, n_ghosts,  true, pencil)
  var coords_z_wg = partition_zpencil_coords(coords, n_ghosts,  true, pencil)
  ...
  __demand(__parallel)
  for i in pencil do
    initialize_coords(coords_x_wg[i], dx, dy, dz)
  end

  for i in pencil do
    var bounds_0 = coords_x_wg[i].ispace.bounds
  ...
  for i in pencil do
    var bounds_0 = coords_y_wg[i].ispace.bounds
  ...
  for i in pencil do
    var bounds_0 = coords_z_wg[i].ispace.bounds
  ...
  for i in pencil do
    ...
    regentlib.assert( bounds_0.lo.x == n_ghosts,                   "coords: x lower bounds in x partition is wrong." )
    regentlib.assert( bounds_0.hi.x == Nx_g-n_ghosts-1,            "coords: x upper bounds in x partition is wrong." )
  ...
  for i in pencil do
    ...
    regentlib.assert( bounds_0.lo.y == n_ghosts,                   "coords: y lower bounds in y partition is wrong." )
    regentlib.assert( bounds_0.hi.y == Ny_g-n_ghosts-1,            "coords: y upper bounds in y partition is wrong." )
  ...
  for i in pencil do
    ...
    regentlib.assert( bounds_0.lo.z == n_ghosts,                   "coords: z lower bounds in z partition is wrong." )
    regentlib.assert( bounds_0.hi.z == Nz_g-n_ghosts-1,            "coords: z upper bounds in z partition is wrong." )
