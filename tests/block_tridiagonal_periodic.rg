  ...
  for k = bounds.lo.z, bounds.hi.z+1 do
    for j = bounds.lo.y, bounds.hi.y+1 do
      ...
      if periodic then
        ...
        beta[{0,j,k}]._2 = beta[{0,j,k}]._2 + alpha[{0,j,k}]._2
        beta[{0,j,k}]._3 = beta[{0,j,k}]._3 + alpha[{0,j,k}]._3

        beta[{N-1,j,k}]._1 = beta[{N-1,j,k}]._1 + gamma[{N-1,j,k}]._1
        beta[{N-1,j,k}]._2 = beta[{N-1,j,k}]._2 + gamma[{N-1,j,k}]._2
        beta[{N-1,j,k}]._3 = beta[{N-1,j,k}]._3 + gamma[{N-1,j,k}]._3
      end
      ...
      if periodic then
        ...
        multiply_diagonal_l( Uinv[{0,j,k}], alpha[{0,j,k}]._1, alpha[{0,j,k}]._2, alpha[{0,j,k}]._3 )
      end
      ...
      if periodic then
        ...
        multiply_diagonal_l( Rinv, gamma[{N-1,j,k}]._1, gamma[{N-1,j,k}]._2, gamma[{N-1,j,k}]._3 )
