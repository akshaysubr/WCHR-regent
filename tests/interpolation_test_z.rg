...
task main()
  ...
  var alpha_l = region( grid_e_z, coeffs )
  var beta_l  = region( grid_e_z, coeffs )
  var gamma_l = region( grid_e_z, coeffs )

  var alpha_r = region( grid_e_z, coeffs )
  var beta_r  = region( grid_e_z, coeffs )
  var gamma_r = region( grid_e_z, coeffs )

  var rho_avg = region( grid_e_z, double )
  var sos_avg = region( grid_e_z, double )

  var block_d    = region( grid_e_z, double[9] )
  var block_Uinv = region( grid_e_z, double[9] )
  --------------------------------------------------------------------------------------------
  --------------------------------------------------------------------------------------------
  ...
  if (problem.periodic_z) then
    token += periodic_ghost_cells_z(r_prim_c, n_ghosts)
  end
  wait_for(token)
