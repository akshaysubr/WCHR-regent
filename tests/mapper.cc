...
static LegionRuntime::Logger::Category log_mapper("test_mapper");

class LayoutTestMapper : public DefaultMapper
{
public:
  LayoutTestMapper(MapperRuntime *rt, Machine machine, Processor local,
...
LayoutTestMapper::LayoutTestMapper(MapperRuntime *rt, Machine machine, Processor local,
                             const char *mapper_name,
...
void LayoutTestMapper::map_task(const MapperContext  ctx,
                                const Task&          task,
                                const MapTaskInput&  input,
                                      MapTaskOutput& output)
{
                                         ...
                                         const std::set<Processor> &local_procs)
{
  ...
  {
    LayoutTestMapper* mapper = new LayoutTestMapper(runtime->get_mapper_runtime(),
